            ...
            ZStack {
                ...
                LinearGradient(
                    stops: [
                        ...
                        .init(color: AppColors.cyan.opacity(coneOpacity * 0.20),    location: 0.25),
                        .init(color: AppColors.purple.opacity(coneOpacity * 0.28),  location: 0.55),
                        .init(color: AppColors.purple.opacity(coneOpacity * 0.14),  location: 0.82),
                ...
                LinearGradient(
                    stops: [
                        .init(color: .clear,                                        location: 0.00),
                        .init(color: AppColors.cyan.opacity(coneOpacity * 0.50),    location: 0.20),
                        .init(color: AppColors.purple.opacity(coneOpacity * 0.70),  location: 0.52),
                        .init(color: AppColors.purple.opacity(coneOpacity * 0.40),  location: 0.80),
                        .init(color: .clear,                                        location: 1.00),
                    ],
                    startPoint: .top,
                    endPoint:   .bottom
                ...
                EllipticalGradient(
                    stops: [
                        .init(color: AppColors.purple.opacity(haloOpacity * 0.22), location: 0.0),
                        .init(color: AppColors.cyan.opacity(haloOpacity * 0.10),   location: 0.5),
                ...
                LinearGradient(
                    stops: [
                        .init(color: .clear,                                         location: 0.00),
                        .init(color: AppColors.cyan.opacity(scanOpacity * 0.90),     location: 0.12),
                        .init(color: AppColors.purple.opacity(scanOpacity),          location: 0.50),
                        .init(color: AppColors.cyan.opacity(scanOpacity * 0.90),     location: 0.88),
                        .init(color: .clear,                                         location: 1.00),
                    ],
                    startPoint: .leading,
                    endPoint:   .trailing
